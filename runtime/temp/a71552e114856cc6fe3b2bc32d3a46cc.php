  ...
  <div class="main">
    <div class="post lightbox">
      ...
      <div class="entry">
        ...
        <p>联系Q Q：<?php echo htmlentities((isset($ContactInfoList['qq']) && ($ContactInfoList['qq'] !== '')?$ContactInfoList['qq']:'QQ 默认')); ?></p>
        <p>联系邮箱：<a href="mailto:<?php echo htmlentities((isset($ContactInfoList['email']) && ($ContactInfoList['email'] !== '')?$ContactInfoList['email']:'email 默认')); ?>"><?php echo htmlentities((isset($ContactInfoList['email']) && ($ContactInfoList['email'] !== '')?$ContactInfoList['email']:'email 默认')); ?></a> </p>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        <p>官方网站：<a target="_blank" href="<?php echo htmlentities($webInfo['realm']); ?>"><?php echo htmlentities($webInfo['realm']); ?></a></p>
      </div>
    </div>
  </div>
</div>
