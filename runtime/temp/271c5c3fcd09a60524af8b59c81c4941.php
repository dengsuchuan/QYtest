...
<div id="container">
  <div class="sidebar">
    <div class="sideMenu">
      <h3><a href="<?php echo url('index/product/index'); ?>#container" title="产品中心">产品中心</a></h3>
      <ul>
          <?php if(is_array($GoodsClassLists) || $GoodsClassLists instanceof \think\Collection || $GoodsClassLists instanceof \think\Paginator): $i = 0; $__LIST__ = $GoodsClassLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$GoodsClassList): $mod = ($i % 2 );++$i;?>
          <li class="menu-item"><a href="<?php echo url('index/Product/productClassifyShow',['GoodsClassId'=>$GoodsClassList['GoodsClassId']]); ?>#container"><?php echo htmlentities($GoodsClassList['ClassName']); ?></a></li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    <div class="widget">
  ...
  <div class="main">
    <div class="itemList">
      <h3><?php echo htmlentities($goodsClassName); ?></h3>
      <ul>
        <?php if(is_array($GoodsInfo) || $GoodsInfo instanceof \think\Collection || $GoodsInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $GoodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$GoodsInfoList): $mod = ($i % 2 );++$i;?>
        <li>
          <div class="thumbnail">
            <a href="#<?php echo htmlentities((isset($GoodsInfoList['id']) && ($GoodsInfoList['id'] !== '')?$GoodsInfoList['id']:'默认')); ?>" title="<?php echo htmlentities((isset($GoodsInfoList['goodsname']) && ($GoodsInfoList['goodsname'] !== '')?$GoodsInfoList['goodsname']:'默认')); ?>" target="_blank">
                <img alt="<?php echo htmlentities((isset($GoodsInfoList['goodsname']) && ($GoodsInfoList['goodsname'] !== '')?$GoodsInfoList['goodsname']:'默认')); ?>" src="/static/index/images/goods/<?php echo htmlentities((isset($GoodsInfoList['images']) && ($GoodsInfoList['images'] !== '')?$GoodsInfoList['images']:'默认')); ?>"/>
            </a>
            <div class="onBackground"> <a href="#<?php echo htmlentities((isset($GoodsInfoList['id']) && ($GoodsInfoList['id'] !== '')?$GoodsInfoList['id']:'默认')); ?>" title="<?php echo htmlentities((isset($GoodsInfoList['goodsname']) && ($GoodsInfoList['goodsname'] !== '')?$GoodsInfoList['goodsname']:'默认')); ?>" target="_blank"></a> </div>
          </div>
          <h2> <a href="#<?php echo htmlentities((isset($GoodsInfoList['newsId']) && ($GoodsInfoList['newsId'] !== '')?$GoodsInfoList['newsId']:'默认')); ?>l" title="<?php echo htmlentities((isset($GoodsInfoList['goodsname']) && ($GoodsInfoList['goodsname'] !== '')?$GoodsInfoList['goodsname']:'默认')); ?>" target="_blank"><?php echo htmlentities((isset($GoodsInfoList['goodsname']) && ($GoodsInfoList['goodsname'] !== '')?$GoodsInfoList['goodsname']:'默认】')); ?></a> </h2>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
        <div id="page"><?php echo $GoodsInfo; ?></div>
        <style>
            #page  ul li{
                float: left;
                width:20px;
