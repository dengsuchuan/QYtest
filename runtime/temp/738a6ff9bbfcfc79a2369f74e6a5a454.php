...
<div id="container">
  <div class="sidebar">
    <div class="sideMenu">
      <h3><a href="<?php echo url('index/Cases/index'); ?>#container" title="案例展示">案例展示</a></h3>
      <ul>
        <?php if(is_array($CasesClassLists) || $CasesClassLists instanceof \think\Collection || $CasesClassLists instanceof \think\Paginator): $i = 0; $__LIST__ = $CasesClassLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$CasesClassList): $mod = ($i % 2 );++$i;?>
        <li class="menu-item"><a href="<?php echo url('index/Cases/caseClassifyShow',['CaseClassId'=>$CasesClassList['CaseClassId']]); ?>#container"><?php echo htmlentities($CasesClassList['ClassName']); ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    <div class="widget">
  ...
  <div class="main">
    <div class="itemList">
      <h3><?php echo htmlentities($caseClassName); ?></h3>
      <ul>
        <?php if(is_array($caseInfo) || $caseInfo instanceof \think\Collection || $caseInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $caseInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$CaseInfoList): $mod = ($i % 2 );++$i;?>
        <li>
          <div class="thumbnail">
              <a href="<?php echo htmlentities($CaseInfoList['caseId']); ?>" title="<?php echo htmlentities($CaseInfoList['casename']); ?>" target="_blank">
                  <img alt="<?php echo htmlentities($CaseInfoList['casename']); ?>" src="/static/index/images/case/<?php echo htmlentities($CaseInfoList['images']); ?>"/>
              </a>
            <div class="onBackground"> <a href="<?php echo htmlentities($CaseInfoList['caseId']); ?>" title="<?php echo htmlentities($CaseInfoList['casename']); ?>" target="_blank"></a> </div>
          </div>
          <h2> <a href="<?php echo htmlentities($CaseInfoList['caseId']); ?>" title="<?php echo htmlentities($CaseInfoList['casename']); ?>" target="_blank"><?php echo htmlentities($CaseInfoList['casename']); ?></a> </h2>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
        <div id="page"><?php echo $caseInfo; ?></div>
        <style>
            #page  ul li{
                float: left;
                width:20px;
