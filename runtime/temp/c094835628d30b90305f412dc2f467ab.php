...
<div id="container">
  <div class="sidebar">
    <div class="sideMenu">
      <h3><a href="{:url('index/Index/index')"  title="返回首页" target="_blank">返回首页</a></h3>
      <ul>
        <li>
          <a href="<?php echo url('index/product/index'); ?>"  class="">产品中心</a>
        </li>
  ...
  <div class="main">
    <div class="post lightbox">
      <h2>关于我们</h2>
      <div class="entry">
        <?php if(is_array($aboutInfo) || $aboutInfo instanceof \think\Collection || $aboutInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $aboutInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aboutInfoList): $mod = ($i % 2 );++$i;?>
          <p><?php echo htmlentities($aboutInfoList['describedefault']='【默认描述】'); ?></p>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </div>
    </div>
  </div>
